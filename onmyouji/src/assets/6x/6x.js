...
function account(){
	...
	else if (zudui == "当队长（带狗粮队长）") {exprate = 2.2*1.3;}
	else if (zudui == "当队长（全带狗粮）") {exprate = 3.2*1.3;}
	else if (zudui == "当队员（带狗粮队长）") {exprate = 3.2*1.3;}
	else if (zudui == "当队员（全带狗粮）") {exprate = 4.2*1.3;}
	else{};
